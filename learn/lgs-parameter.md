...
.param-table td{padding:var(--space-3) var(--space-4);border-bottom:1px solid rgba(227,227,232,0.06);color:var(--text-secondary);vertical-align:top;background:transparent!important;}
