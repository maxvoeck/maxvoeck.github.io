...
.param-table td{padding:var(--space-3) var(--space-4);border-bottom:1px solid rgba(232,228,220,0.06);color:var(--text-secondary);vertical-align:top;background:transparent!important;}
