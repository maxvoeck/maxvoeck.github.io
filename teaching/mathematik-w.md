...
const KAPITEL = [
  {
    ...
    module: [
      ...
      { id:'a4', nr:'04', titel:'Lineare Gleichungssysteme', desc:'Erweiterte Koeffizientenmatrix, Gauß-Algorithmus und Zeilenstufenform, Rang einer Matrix, Lösbarkeitskriterien (keine, genau eine, unendlich viele Lösungen) und Rückwärtseinsetzen', pdf:'/assets/pdfs/W_LGS_1.pdf', quiz:'/assets/quizzes/quiz_matrizen_w_lgs.html', text:'/assets/texte/w-lgs-1.pdf' },
      { id:'a5', nr:'05', titel:'LGS mit Parameter', desc:'Parameter auf der rechten Seite, in der Koeffizientenmatrix und an mehreren Stellen; Fallunterscheidung bei parameterabhängigen Pivot-Elementen und Bestimmung der Lösungsmenge in Abhängigkeit vom Parameter', pdf:'/assets/pdfs/W_LGS_2.pdf', quiz:'/assets/quizzes/quiz_matrizen_w_lgs_parameter.html', text:'/assets/texte/w-lgs-2.pdf' },
    ]
  },
  {
    numeral: 'II', titel: 'Finanzmathematik', meta: '2 Module',
    module: [
      ...
      { id:'f2', nr:'02', titel:'Zinseszinsrechnung', desc:'Wachstumsfaktor q, Herleitung und Anwendung der Zinseszinsformel Kn = K0·qⁿ, Auf- und Abzinsen (Barwert), gesuchter Zinssatz und gesuchte Laufzeit über den Logarithmus sowie Vergleich mit einfacher Verzinsung', pdf:'/assets/pdfs/W_Zinseszins_1.pdf', text:'/assets/texte/w-zinseszins-1.pdf' },
    ]
  },
